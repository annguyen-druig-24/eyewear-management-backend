...
public interface ProductMapper {
    ...
    @Mapping(source = "frame.templeLength", target = "templeLength")
    @Mapping(source = "frame.lensWidth", target = "lensWidth")
    @Mapping(source = "frame.bridgeWidth", target = "bridgeWidth")
    ...
    @Mapping(source = "lens.diameter", target = "diameter")
    @Mapping(source = "lens.availablePowerRange", target = "availablePowerRange")
    @Mapping(source = "lens.isBlueLightBlock", target = "isBlueLightBlock")
    @Mapping(source = "lens.isPhotochromic", target = "isPhotochromic")
    @Mapping(source = "lens.lensType.typeName", target = "lensTypeName")
    ...
    @Mapping(source = "contactLens.usageType", target = "usageType")
    @Mapping(source = "contactLens.baseCurve", target = "baseCurve")
    @Mapping(source = "contactLens.waterContent", target = "waterContent")
    @Mapping(source = "contactLens.diameter", target = "diameter")
    @Mapping(source = "contactLens.availablePowerRange", target = "availablePowerRange")
    @Mapping(source = "contactLens.quantityPerBox", target = "quantityPerBox")
    @Mapping(source = "contactLens.lensMaterial", target = "lensMaterial")
    @Mapping(source = "contactLens.replacementSchedule", target = "replacementSchedule")
    @Mapping(source = "contactLens.color", target = "color")
    @Mapping(source = "productType.typeName", target = "product_Type")
